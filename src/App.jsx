...
function TabsBar(){
    ...
    return (
        <Paper elevation={0} sx={{ px: 2, pt: 1, pb: 0, bgcolor:'#E4E8F4', borderRadius:'12px 12px 0 0', borderBottom:'3px solid #6F79A8' }}>
...
/* 专用 Layout */
function CPLayout(){ return <SidebarLayout title="Competitive Positioning" items={CP_MENU} /> }
function MRALayout(){ return <SidebarLayout title="Market Reach Analysis" items={MRA_MENU} /> }
