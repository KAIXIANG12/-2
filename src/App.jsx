...
// ---- 顶部一级导航 ----
const TOP = [
    { key: 'cp', label: 'Competitive Positioning', path: '/cp/cvo' }, // 默认指向 CVO
                ...
                <Toolbar sx={{ minHeight: 64, px: 2 }}>
                    ...
                    <Typography variant="h6" sx={{ fontWeight: 800, letterSpacing: .3 }}>
                        ...
                        <Box component="span" sx={{
                            ml: .5, px: .5, borderRadius: .5, bgcolor:'#D95359', color:'#fff', fontWeight: 900
                        }}>ALLY</Box>
                    </Typography>
    ...
    return (
        <Paper elevation={0}
            ...
            <Tabs value={current} textColor="inherit"
                  TabIndicatorProps={{ sx:{ bgcolor:'#8A51F1', height: 3 } }}>
                {TOP.map(t => (
        ...
        <Box sx={{ bgcolor:'#6F79A8', minHeight:'100vh', pb: 6 }}>
            ...
            <Container maxWidth={false} sx={{ px: 4 }}>
                <Paper elevation={0} sx={{
                    mt: 2, borderRadius: 2, overflow:'hidden', bgcolor:'#F3F4F8', width:'100%'
                }}>
                    <TabsBar />
                    <Box sx={{ p: 2 }}>
                        {children}
    ...
    return (
        <Frame>
            <Routes>
                ...
                <Route path="/fb" element={<Placeholder title="Financial Benchmarking (coming soon)" />} />
